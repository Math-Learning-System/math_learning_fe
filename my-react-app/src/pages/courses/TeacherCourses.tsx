...
const tcPrimaryBtn =
  'inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-[#0ea5e9] text-[#ffffff] font-[Be_Vietnam_Pro] text-[13px] font-semibold hover:brightness-95 active:scale-[0.98] transition-all duration-150';
          ...
          <section className="module-page teacher-courses-page teacher-courses-index-page space-y-6 min-w-0">
            ...
            <div className="flex flex-col gap-3">
              <div className="bg-white rounded-2xl border border-[#e2e8f0] overflow-hidden">
                <label className="flex items-center gap-3 px-4 py-3 border-b border-[#e2e8f0] focus-within:bg-[#ffffff] transition-colors duration-150">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-3 flex-wrap">
                <div className="flex flex-wrap items-center gap-1 p-1 bg-[#f8fafc] rounded-xl flex-1 min-w-0">
                  {filterTabs.map((tab) => (
                    <button
                      key={tab.id}
                      type="button"
            ...
            {!isLoading && !error && filteredCourses.length > PAGE_SIZE && (
              <div className="flex items-center justify-center gap-3 pt-1 flex-wrap">
                ...
                <span className="font-[Be_Vietnam_Pro] text-[13px] text-[#475569] tabular-nums">
                  Trang <strong className="text-[#0f172a]">{safeCurrentPage}</strong> / {totalPages}
                </span>
                <button
                  type="button"
                  className={tcSecondaryBtn}
