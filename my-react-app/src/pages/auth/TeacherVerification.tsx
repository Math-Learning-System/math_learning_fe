...
const TeacherVerification: React.FC = () => {
  ...
  // Form State — auto-fill email from JWT (set at Google login)
  const _tokenEmail = (() => {
  ...
  const renderStep1 = () => (
    <div className="verification-step">
      ...
      <p className="step-desc">
        MathMaster cung cấp các công cụ và tài nguyên miễn phí cho giáo viên. Hãy xác thực để bắt
        đầu.
      </p>
  ...
  const renderStep2 = () => (
    <div className="verification-step">
      <div className="step-header">
        ...
        <h2 className="step-title" style={{ marginLeft: '1rem', display: 'inline' }}>
          Tải lên tài liệu xác thực
        </h2>
      </div>
      <p className="step-desc" style={{ marginTop: '1rem' }}>
        Sử dụng Thẻ Cán bộ, Công chức, Viên chức (Giáo Viên) có tên bạn và tên trường.
      </p>
      ...
      <div className="form-group" style={{ marginTop: '2rem' }}>
        ...
        <div
          ...
          style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '1rem', marginTop: '0.5rem' }}
        >
          <div
      ...
      <div
        ...
        style={{ marginTop: '1.5rem', display: 'flex', gap: '0.5rem', alignItems: 'flex-start' }}
      >
        <input
          type="checkbox"
          id="policy-agree"
  ...
  const renderStep3 = () => (
    <div className="verification-step">
      ...
      >
        ...
        <div className="input-with-icon">
          ...
          <input
            ...
            onFocus={() => {
              if (step3Data.schoolName.trim() && schoolSuggestions.length > 0)
                setShowSuggestions(true);
            }}
            autoComplete="off"
          />
      ...
      <button
        ...
        disabled={
          isLoading || !step3Data.fullName || !step3Data.schoolName || !step3Data.schoolAddress
        }
      >
  ...
  const renderStep4 = () => (
    <div
      ...
      style={{ display: 'flex', gap: '3rem', height: '100%', alignItems: 'center' }}
    >
      <div className="v-content" style={{ flex: 1 }}>
        ...
        <p style={{ color: '#4a5568', marginTop: '1.5rem', fontSize: '1.1rem', lineHeight: '1.6' }}>
          ...
          chúng tôi xem xét hồ sơ của bạn.
        </p>
        <p style={{ color: '#718096', marginTop: '1rem', fontSize: '1rem', lineHeight: '1.6' }}>
          Bạn sẽ nhận được phản hồi từ chúng tôi trong vòng <b>24 giờ</b>, nhưng trong giai đoạn cao
          điểm có thể mất đến 7 ngày.
        </p>
      ...
      {step !== 4 && (
        ...
        >
          <div style={{ textAlign: 'center' }}>
            ...
            <div
              className="stepper"
              style={{ marginTop: '3rem', display: 'flex', justifyContent: 'center', gap: '1rem' }}
            >
              {[1, 2, 3].map((s) => (
                <div
                  key={s}
