...
export const API_ENDPOINTS = {
  ...
  COURSE_LESSON_MATERIAL_DOWNLOAD: (courseId: string, lessonId: string, materialId: string) =>
  ...
  // ── Books (Phase-3 OCR pipeline) — Postgres curriculum + Mongo OCR pages ──
  BOOKS: '/v1/books',
  BOOKS_SEARCH: '/v1/books',
  ...
  BOOK_OCR_SINGLE_PAGE: (bookId: string) => `/v1/books/${bookId}/ocr/single-page`,
